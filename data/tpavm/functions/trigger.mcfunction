...
execute as @a if score @s sethome matches -2147483648..2147483647 if score @s sethome matches 1..5 run function tpavm:home/sethome
execute as @a if score @s sethome matches -2147483648..2147483647 unless score @s sethome matches 0 run function tpavm:home/sethome_invalid
